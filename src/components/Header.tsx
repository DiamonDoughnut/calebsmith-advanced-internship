...
const Header = () => {
  return (
    <div className='fixed top-0 left-0 w-full h-20 bg-transparent border-b-2 border-neutral-100 flex items-center justify-end'>
        <div className='h-1/2 relative min-w-80 rounded-md bg-neutral-200 -translate-x-40'>
